...
const CreditForm = ({ form, callback }: IShippingFormProps) => {
	...
	return (
		<div className=" border">
			<p className="text-2xl font-bold py-3 ps-3">
				PAYMENT DETAILS
				</p>
				<Separator />
			...
			<Form {...form}>
				...
				>
					<FormField
						...
						render={({ field }) => (
							<FormItem>
								<div className="flex items-center gap-4 p-3 px-10">
									<FormLabel className="min-w-[110px]">Card Holder</FormLabel>
									<FormControl>
										<Input
					...
					<FormField
						...
						render={({ field }) => (
							<FormItem>
								<div className="flex items-center gap-4 p-3 px-10">
									<FormLabel className="min-w-[110px]">Card Number</FormLabel>
									<FormControl>
										<Input
