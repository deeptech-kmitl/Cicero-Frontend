					...
					{user.fname ? (
						<div className="flex items-center justify-between space-x-2">
							...
							<div className="group relative cursor-pointer py-2 ">
								...
								<div className=" transition-all bg-white absolute z-50 -left-20  rounded-lg flex flex-col px-5 py-3 text-gray-800 shadow-xl invisible group-hover:visible transform translate-y-2 group-hover:translate-y-0">
									<>
										<Link href={"/profile"}>
											<p>
